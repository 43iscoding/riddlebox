...
public class EventDelegate
{
	...
	//SD ne hvatalo SET s avtomaticheskim clear i oneshot = true
	/// <summary>
	/// ONESHOT: Assign a new event delegate.
	/// </summary>

	static public EventDelegate Set(List<EventDelegate> list, Callback callback, bool oneShot)
	{
		if (list != null)
		{
			list.Clear();
