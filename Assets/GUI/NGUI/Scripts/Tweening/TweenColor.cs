...
public class TweenColor : UITweener
{
	...
	void Cache ()
	{
		...
		//sd
		mLensFlare = GetComponent<LensFlare>();
		if (mWidget == null && mMat == null && mLight == null && mLensFlare == null)
	...
	public Color value
	{
		get
		{
			...
			//sd
			if (mLensFlare != null) return mLensFlare.color;
		...
		set
		{
			...
			if (mLensFlare != null)
			{
				mLensFlare.color = value;
				mLensFlare.enabled = (value.r + value.g + value.b) > 0.01f;
			}
		}
	}
