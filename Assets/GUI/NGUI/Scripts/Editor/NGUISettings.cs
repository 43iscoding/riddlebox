...
#region Convenience accessor properties
	...
	static void CopyLabel (UILabel lbl)
	{
		...
		//sd label flaot spacing
		SetFloat("SpacingX", lbl.spacingX);
		...
		//sd
        SetBool("DiagonalGradient", lbl.diagonalGradient);
		...
		//sd
		SetColor("Effect CB", lbl.effectColorBottom);
	...
	static void PasteLabel (UILabel lbl, bool fully)
	{
		...
		//sd label flaot spacing
		lbl.spacingX = GetFloat("SpacingX", lbl.spacingX);
        ...
        lbl.diagonalGradient = GetBool("DiagonalGradient", lbl.diagonalGradient);
		...
		//sd
		lbl.effectColorBottom = GetColor("Effect CB", lbl.effectColorBottom);
