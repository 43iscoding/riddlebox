		...
		if (mSprite == null && mAtlas != null)
		{
			if (!string.IsNullOrEmpty(mSpriteName))
			{
				...
				if (sp == null)
				{
					...
					Transform parent4 = null;


					parent1 = transform.parent;
					if (parent1 != null)
						parent2 = parent1.transform.parent;
					if (parent2 != null)
						parent3 = parent2.transform.parent;
					if (parent3 != null)
						parent4 = parent3.transform.parent;

					string parents = "";
					parents += transform.name;
					if (parent1 != null)
						parents += "/" + parent1.name;
					if (parent2 != null)
						parents += "/" + parent2.name;
					if (parent3 != null)
						parents += "/" + parent3.name;
					if (parent4 != null)
						parents += "/" + parent4.name;


					Debug.Log("Sprite not found: " + mSpriteName + " for " + parents, gameObject);
					return null;
				}
				SetAtlasSprite(sp);
			}
